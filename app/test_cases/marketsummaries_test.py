...
def test_market_summaries(client, username, password):
    # urls
    summaries_url = "/api/v1/marketsummaries"
...
def test_market_summaries_without_authtoken(client):
    # urls
    summaries_url = "/api/v1/marketsummaries"
...
def test_market_summaries_invalid_token(client, token):
    # urls
    summaries_url = "/api/v1/marketsummaries"
